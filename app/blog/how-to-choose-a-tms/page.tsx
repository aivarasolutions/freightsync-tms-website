        ...
        <Container>
          <div className="max-w-3xl mx-auto">
            ...
            <header className="mb-12">
              <h1 className="text-4xl sm:text-5xl font-bold text-secondary dark:text-white mb-4">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <h2 className="text-3xl font-bold text-secondary dark:text-white mt-12 mb-6">
              ...
              <h3 className="text-2xl font-semibold text-secondary dark:text-white mt-8 mb-4">
              ...
              <ol className="space-y-4 text-gray-600 dark:text-gray-300 mb-8 list-decimal list-inside">
